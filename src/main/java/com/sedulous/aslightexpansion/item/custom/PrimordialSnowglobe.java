...
public class PrimordialSnowglobe extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal("Frigid Wasteland:"));
        tooltip.add(Component.literal("§7While in your offhand, generates a ring of snow particles."));
        tooltip.add(Component.literal("§7All hostile entities inside the ring are inflicted with an increasing slowness and are weakened."));
    }
